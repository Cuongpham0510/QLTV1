 ...
 * @author Lenovo L340
 */
public class TheMuonMannagement extends javax.swing.JPanel {
    ...
    private void showTheTV(){
        List<TheMuon> TheMuonList = TheMuonModify.finAll();
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
        ...
        try {
            list = TheMuonModify.timkiem(txtmathe.getText());
                    if(list.isEmpty()){
                        JOptionPane.showMessageDialog(this, "Mã thẻ không tồn tại!");
                        txtmathe.setText("");
                    }else{
                        TheMuonModify.delete(txtmathe.getText());
    ...
    private void btnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsuaActionPerformed
        ...
        try {
            ...
            TheMuon tm = new TheMuon(maThe, tendocgia, ngayBD, ngayKT, ghichu, lop, khoa, ngaysinh);
            list = TheMuonModify.timkiem(maThe);
                    if(list.isEmpty()){
                        JOptionPane.showMessageDialog(this, "Không được phép sửa mã thẻ!");
                        txtmathe.setText("");
                    }else{
                        TheMuonModify.update(tm);
